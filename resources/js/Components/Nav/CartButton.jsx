...
export default function CartButton() {
    ...
    return (
        <div style={{position: 'relative', display: 'inline-block'}} className="cart">
            ...
            {/* Toggle Dropdown */}
            <div ref={dropdownRef}
                className={`cart-dropdown z-40 transition-all duration-300 ease-in-out ${isDropdownVisible ? 'opacity-100 visible translate-y-0' : 'opacity-0 invisible translate-y-6'}`}>
